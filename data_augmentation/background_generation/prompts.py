...
prompts = [
    ...
    "A space scene shot from a satellite, showing a dense collection of stars and a distant galaxy, the stars are bright against a black background, slight lens glare and chromatic aberrations.",
    "A partially blurred image of a planet shot from a satellite, the planet’s features are indistinct with a heavy motion blur, simulating a fast-moving spacecraft capturing the scene.",
...
print("Prompts have been written to prompts.txt")