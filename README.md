...
If you use our dataset or code, please cite our [paper](https://arxiv.org/abs/2507.10775){:target="_blank"}.

## Model files and Datasets
All the trained models can be found [here](https://drive.google.com/drive/folders/1WxbuNpZJu50HF27rXzarGAWMtwsZDdTc?usp=drive_link){:target="_blank"}. Download the appropriate pt file and save it under `models/` directory.

All the dataset versions can be found [here](https://huggingface.co/datasets/JeffreyJsam/SWiM-SpacecraftWithMasks){:target="_blank"}. Download the appropriate dataset, unzip it and save it under the `data/` folder.
